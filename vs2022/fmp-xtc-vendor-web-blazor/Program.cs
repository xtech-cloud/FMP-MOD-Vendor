...
using XTC.FMP.MOD.Vendor.App.Web;
...
public partial class Program
{
    public static async Task Main(string[] args)
    {
        ...
        permissioS[Permissions.UnityCreate] = "";
        permissioS[Permissions.UnityUpdate] = "";
        permissioS[Permissions.UnityRetrieve] = "";
        permissioS[Permissions.UnityDelete] = "";
        ...
        framework.setUserData("XTC.FMP.MOD.Vendor.LIB.MVCS.Entry", entry);
