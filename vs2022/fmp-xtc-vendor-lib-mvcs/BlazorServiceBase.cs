...
namespace XTC.FMP.MOD.Vendor.LIB.MVCS
{
    ...
    /// Blazor服务层基类
    /// </summary>
    public class BlazorServiceBase : Service
    {
        public BlazorServiceMock mock { get; set; } = new BlazorServiceMock();
        ...
        public BlazorServiceBase(string _uid, string _gid) : base(_uid)
        {
            gid_ = _gid;
        }
        ...
        /// <returns>错误</returns>
        public virtual async Task<Error> CallCreate(BlazorCreateRequest? _request, object? _context)
        {
        ...
        /// <returns>错误</returns>
        public virtual async Task<Error> CallUpdate(BlazorUpdateRequest? _request, object? _context)
        {
        ...
        public virtual async Task<Error> CallRetrieve(UuidRequest? _request, object? _context)
        {
            ...
            BlazorRetrieveResponse? response = null;
        ...
        /// <returns>错误</returns>
        public virtual async Task<Error> CallList(BlazorListRequest? _request, object? _context)
        {
            ...
            BlazorListResponse? response = null;
        ...
        /// <returns>错误</returns>
        public virtual async Task<Error> CallSearch(BlazorSearchRequest? _request, object? _context)
        {
        ...
        protected Blazor.BlazorClient? getGrpcClient()
        {
            if (null == grpcChannel_)
                return null;

            if(null == clientBlazor_)
            {
                clientBlazor_ = new Blazor.BlazorClient(grpcChannel_);
            }
            return clientBlazor_;
        }
        ...
        /// GRPC客户端
        /// </summary>
        protected Blazor.BlazorClient? clientBlazor_;
